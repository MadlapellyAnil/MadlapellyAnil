...
<title>Sri Varsha Resort Booking</title>
<style>
  body, html {
    height: 100%;
    margin: 0;
    font-family: Arial, sans-serif;
    background-image: url('resources/Varsha.jpg');
...
<div class="container">
  ...
  <h1 style="color:red;" class="underline">Sri Varsha Resort</h1>
  ...
  <ul>
    <li>Single Room: Rs. 8999</li>
    <li>Double Room: Rs. 16999</li>
    <li>Suite: Rs. 22999</li>
  </ul>
  
  <a href="booking?resortType=VarshaResort" class="btn">Select This Resort</a>
</div>
