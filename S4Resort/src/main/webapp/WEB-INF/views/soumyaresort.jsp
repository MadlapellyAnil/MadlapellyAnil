...
<title>Soumya Resort Booking</title>
<style>
  body, html {
    margin: 0;
    font-family: Arial, sans-serif;
    background-image: url('resources/Soumya.jpg');
...
<div class="container">
  ...
  <h2 style="color:red;">Soumya Resort</h2>
  ...
  <ul>
    <li>Single Room: Rs. 9999</li>
    <li>Double Room: Rs. 15999</li>
    <li>Suite: Rs. 20999</li>
  </ul>
  
  <a href="booking?resortType=soumyaresort" class="btn">Select This Resort</a>
</div>
